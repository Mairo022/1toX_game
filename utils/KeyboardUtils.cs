...
public static class KeyboardUtils
{
    ...
    public static bool IsBackKey(KeyboardState keyboard, KeyboardState oldKeyboard)
    {
        var keys = keyboard.GetPressedKeys();
        ...
        return keys[0] == Keys.Back;
    }

    public static readonly Func<char, bool> IsCharNumber = char.IsNumber;
}